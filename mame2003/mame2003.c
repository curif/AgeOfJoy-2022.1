...
bool retro_load_game(const struct retro_game_info *game)
{
  ...
  log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game init_game\n");
  ...
  if (Machine->drv == 0) 
  {
    log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game ERROR set_content_flags screw drv\n");
    return 0;
  }
  ...
  if (Machine->drv == 0) 
  {
    log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game ERROR change options screw drv\n");
    return 0;
  }
  ...
  if (Machine->drv == 0) 
  {
    log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game ERROR init_core_optionscrew drv\n");
    return 0;
  }
  update_variables(true);
  if (Machine->drv == 0) 
  {
    log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game ERROR update_variable screw drv\n");
    return 0;
  }
  ...
  if (Machine->drv == 0) 
  {
    log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game ERROR configure_cyclone_mode change options screw drv\n");
    return 0;
  }
  ...
  if (Machine->drv == 0) 
  {
    log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game ERROR RETRO_ENVIRONMENT_SET_CONTROLLER_INFO screw drv\n");
    return 0;
  }

  log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game run_game\n");
  if(!run_game(driverIndex))
  {
    log_cb(RETRO_LOG_INFO, LOGPRE " curif retro_load_game run_game END with true\n");
    return true;
  }
  log_cb(RETRO_LOG_INFO, LOGPRE " curif run_game END with false\n");
  return false;
}
