...
Shader "AgeOfJoy/MuseumFloor"
{
	Properties
	{
		...
		_Vector1("Vector 1", Vector) = (0.5,0.25,0,0)
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( saturate( ( ( sin( ( v.texcoord.xy.y + fmod( _Time.y , 120.0 ) ) ) + 1.0 ) / 2.0 ) ) * v.color.r ) * _Vector1 );
			v.vertex.w = 1;
		}
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.SimpleTimeNode;155;-175.8409,1656.595;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FmodOpNode;166;98.82532,1597.928;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;120;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector3Node;161;1531.492,1742.595;Inherit;False;Property;_Vector1;Vector 1;6;0;Create;True;0;0;0;False;0;False;0.5,0.25,0;0.07,0.1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;74;1526.842,1153.039;Inherit;False;Property;_Metallic;Metallic;3;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;138;1521.192,1272.814;Inherit;False;Property;_Sm;Sm;4;0;Create;True;0;0;0;False;0;False;0.46;0.164;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;89;211.0946,784.8682;Inherit;True;Property;_Texture0;Texture 0;5;0;Create;True;0;0;0;False;0;False;None;4809541d25f34dc499bbf5ff78b719f6;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;165;421.4921,1807.262;Inherit;False;SHAF_TimeBox;1;;1;fe42b26378975cf4dbc110668364facf;0;1;10;FLOAT;1;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=6075601B8332004AC206DCBC7A762E610BB3BED4