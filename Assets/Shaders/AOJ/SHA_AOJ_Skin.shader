...
Shader "SHA_AOJ_Skin"
{
	Properties
	{
		...
		_FresnelPower("FresnelPower", Range( 0 , 10)) = 4.86
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			half fresnelNdotV2 = dot( ase_worldNormal, i.viewDir );
			half fresnelNode2 = ( _FresnelBias + 1.0 * pow( 1.0 - fresnelNdotV2, _FresnelPower ) );
			o.Emission = ( _SSSColor * fresnelNode2 ).rgb;
			o.Metallic = 0.0;
...
Node;AmplifyShaderEditor.ColorNode;9;-1091.333,-76.16658;Inherit;False;Property;_SSSColor;SSS Color;3;0;Create;True;0;0;0;False;0;False;0.1411765,0.07450981,0.07450981,0;0.1415094,0.07542717,0.07542717,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-547.3332,-112.8334;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;5228a3698d6358a42ac88adca3dfd555;8d77265469b19103ab103e5cafadcc0d;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;7;-387.9999,152.5001;Inherit;False;Constant;_Metallic;Metallic;1;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8B737B95914683FD9F59292BA3AA5995764F9EFA