...
Shader "AgeOfJoy/EntryPortal"
{
	...
	SubShader
	{
		...
		struct Input
		{
			float2 vertexToFrag53;
			float2 uv_texcoord;
			float2 vertexToFrag52;
			float3 worldPos;
		};
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float temp_output_10_0 = max( tex2D( _Texture0, ( float3( i.vertexToFrag53 ,  0.0 ) + temp_output_19_0 ).xy ).r , tex2D( _Texture0, ( float3( i.vertexToFrag52 ,  0.0 ) + temp_output_19_0 ).xy ).g );
...
Node;AmplifyShaderEditor.RangedFloatNode;29;725.2761,837.1503;Inherit;False;Property;_TransitionDistance;TransitionDistance;4;0;Create;True;0;0;0;False;0;False;3;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;35;1048.609,1025.15;Inherit;False;Property;_POwer;POwer;5;0;Create;True;0;0;0;False;0;False;5;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;14;-198.0572,657.15;Inherit;False;Property;_Color1;Color 1;3;0;Create;True;0;0;0;False;0;False;0.2578616,0.09261715,0,0;0,0.4231023,0.5568628,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=47ED2CF3CEBC0100ED0886E5BC4E0D8F1DDD1CBF