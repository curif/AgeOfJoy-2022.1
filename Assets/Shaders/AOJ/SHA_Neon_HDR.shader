// Upgrade NOTE: upgraded instancing buffer 'AgeOfJoyNeon_HDR' to new syntax.

// Made with Amplify Shader Editor v1.9.3.2
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "AgeOfJoy/Neon_HDR"
{
	Properties
	{
		_FresnelPower("FresnelPower", Range( 0 , 5)) = 1
		[HDR]_ColorA("Color A", Color) = (0.4716981,0,0,0)
		[HDR]_ColorCore("Color Core", Color) = (0.7735849,0.6738459,0.6738459,0)
	...
	LOD 0
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START(AgeOfJoyNeon_HDR)
				UNITY_DEFINE_INSTANCED_PROP(half4, _ColorA)
#define _ColorA_arr AgeOfJoyNeon_HDR
				UNITY_DEFINE_INSTANCED_PROP(half4, _ColorCore)
#define _ColorCore_arr AgeOfJoyNeon_HDR
			UNITY_INSTANCING_BUFFER_END(AgeOfJoyNeon_HDR)
				...
				) : SV_Target
			{
				...
				half fresnelNdotV4 = dot( IN.ase_normal, worldViewDir );
				half fresnelNode4 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV4, _FresnelPower ) );
				half4 lerpResult5 = lerp( _ColorA_Instance , _ColorCore_Instance , saturate( fresnelNode4 ));
...
#define _ColorCore_arr AgeOfJoyNeon_HDR
				...
				) : SV_Target
			{
				...
				half fresnelNdotV4 = dot( IN.ase_normal, ase_worldViewDir );
				half fresnelNode4 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV4, _FresnelPower ) );
				half4 lerpResult5 = lerp( _ColorA_Instance , _ColorCore_Instance , saturate( fresnelNode4 ));
...
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;13;-1059.333,344.1662;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;8;-1028.333,499.4998;Inherit;False;Property;_FresnelPower;FresnelPower;0;0;Create;True;0;0;0;False;0;False;1;0.12;0;5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;10;-596.3331,-345.1669;Inherit;False;InstancedProperty;_ColorA;Color A;1;1;[HDR];Create;True;0;0;0;False;0;False;0.4716981,0,0,0;0,506.4181,766.9962,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;11;-608.3333,-9.500397;Inherit;False;InstancedProperty;_ColorCore;Color Core;2;1;[HDR];Create;True;0;0;0;False;0;False;0.7735849,0.6738459,0.6738459,0;0,1,0.3223476,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SaturateNode;14;-250.9998,350.3331;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=78E964B48232B38CD84145772496A3007D54DA46