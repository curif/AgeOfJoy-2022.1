...
Shader "AgeOfJoy/Flag"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( ( tex2Dlod( _Texture0, float4( panner48, 0, 0.0) ) * float4( float3(0,0,1) , 0.0 ) ) * ( v.texcoord.xy.x * ( 1.0 - v.texcoord.xy.x ) ) ) + ( ( tex2Dlod( _Texture0, float4( panner64, 0, 0.0) ) * float4( _SmallWaveWPO , 0.0 ) ) * v.color.r ) ).rgb;
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 hsvTorgb4_g2 = RGBToHSV( float4( float3(1,0,0) , 0.0 ).rgb );
			float3 hsvTorgb8_g2 = HSVToRGB( float3(( hsvTorgb4_g2.x + ( i.vertexColor.b * 0.75 ) ),( hsvTorgb4_g2.y + 0.0 ),( hsvTorgb4_g2.z + 0.0 )) );
			o.Albedo = ( ( tex2D( _TextureSample2, uv_TextureSample2 ) * ( 1.0 - i.vertexColor.g ) ) + float4( ( i.vertexColor.r * saturate( hsvTorgb8_g2 ) ) , 0.0 ) ).rgb;
			o.Metallic = 0.0;
			o.Smoothness = 0.0;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.TextureCoordinatesNode;54;475.5875,659.4088;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;63;419.2615,991.5995;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PannerNode;48;658.0405,579.3834;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0.3,0;False;1;FLOAT;1;False;1;FLOAT2;0
Node;AmplifyShaderEditor.TexturePropertyNode;67;602.9211,126.3877;Inherit;True;Property;_Texture0;Texture 0;0;0;Create;True;0;0;0;False;0;False;None;a11563a4124b96c4db654a9ea7217d2c;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.PannerNode;64;688.3811,989.5741;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0.25,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SamplerNode;65;1112.718,1030.69;Inherit;True;Property;_TextureSample1;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;a11563a4124b96c4db654a9ea7217d2c;a11563a4124b96c4db654a9ea7217d2c;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;68;1444.252,1293.574;Inherit;False;Property;_SmallWaveWPO;SmallWaveWPO;1;0;Create;True;0;0;0;False;0;False;0,0,0;0.2,0.01,0.01;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
ASEEND*/
//CHKSM=DE7E8D8B2E268A813343F7431CF3196FFB353ECC