...
Shader "AgeOfJoy/Flag"
{
	Properties
	{
		...
		_HueShiftMax("HueShiftMax", Range( 0 , 1)) = 0.75
		[Toggle(_DISABLEHUESHIFT_ON)] _DisableHueShift("DisableHueShift", Float) = 0
	...
	SubShader
	{
		...
		#pragma target 3.0
		#pragma shader_feature_local _DISABLEHUESHIFT_ON
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			half4 tex2DNode76 = tex2D( _TextureSample2, uv_TextureSample2 );
			float3 hsvTorgb4_g2 = RGBToHSV( half4( half3(1,0,0) , 0.0 ).rgb );
			float3 hsvTorgb8_g2 = HSVToRGB( float3(( hsvTorgb4_g2.x + ( i.vertexColor.b * _HueShiftMax ) ),( hsvTorgb4_g2.y + 0.0 ),( hsvTorgb4_g2.z + 0.0 )) );
			#ifdef _DISABLEHUESHIFT_ON
				half4 staticSwitch86 = tex2DNode76;
			#else
				half4 staticSwitch86 = ( ( tex2DNode76 * ( 1.0 - i.vertexColor.g ) ) + half4( ( i.vertexColor.r * saturate( hsvTorgb8_g2 ) ) , 0.0 ) );
			#endif
			o.Albedo = staticSwitch86.rgb;
			o.Metallic = 0.0;
			o.Smoothness = 0.0;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.VertexColorNode;60;1226.613,84.67334;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;85;1090.516,299.3548;Inherit;False;Property;_HueShiftMax;HueShiftMax;3;0;Create;True;0;0;0;False;0;False;0.75;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;81;1525.587,131.5739;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.75;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;74;1351.586,-423.7592;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;76;1223.253,-835.0928;Inherit;True;Property;_TextureSample2;Texture Sample 2;2;0;Create;True;0;0;0;False;0;False;-1;None;a9c0270a89137a24c9883f706064c754;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;80;1608.253,-351.0929;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;86;2186.516,-498.3119;Inherit;False;Property;_DisableHueShift;DisableHueShift;4;0;Create;True;0;0;0;False;0;False;0;0;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=D81113A16839B0D707BE4F6CE3E4E265EEBF1A19