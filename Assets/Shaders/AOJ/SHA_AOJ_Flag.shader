...
Shader "AgeOfJoy/Flag"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			o.Albedo = ( ( tex2D( _TextureSample2, uv_TextureSample2 ) * ( 1.0 - i.vertexColor.g ) ) + ( i.vertexColor.r * 0.0 ) ).rgb;
			o.Metallic = 0.0;
			o.Smoothness = 0.0;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.TextureCoordinatesNode;63;376.2615,1105.599;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.PannerNode;64;686.3811,1108.574;Inherit;True;3;0;FLOAT2;0,0;False;2;FLOAT2;0.25,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;75;1990.919,-22.42581;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;61;1728.159,72.41699;Inherit;False;HueShift;-1;;2;;0;0;0
...
ASEEND*/
//CHKSM=CC9D96326940F394B70D9817A2FBC6AA5E498BD8