...
Shader "AgeOfJoy/CRT_01"
{
	Properties
	{
		...
		_DotMaskSaturate("DotMaskSaturate", Range( -1 , 1)) = 0
	...
	LOD 100
		...
		Pass
		{
			...
			uniform float _DotMaskSaturate;
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float3 desaturateVar82 = lerp( desaturateInitialColor82, desaturateDot82.xxx, _DotMaskSaturate );
				...
				float4 lerpResult58 = lerp( ( float4( ( desaturateVar82 + _DotMaskBrighten ) , 0.0 ) * tex2D( _TextureSampleDotMask, texCoord61 ) ) , lerpResult28 , clampResult49);
...
Node;AmplifyShaderEditor.RangedFloatNode;83;-299.702,-472.7764;Inherit;False;Property;_DotMaskSaturate;DotMaskSaturate;18;0;Create;True;0;0;0;False;0;False;0;0;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;80;-149.7019,-706.7761;Inherit;False;Property;_DotMaskBrighten;DotMaskBrighten;17;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.DesaturateOpNode;82;-10.70203,-572.7764;Inherit;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WireNode;64;3.429863,81.67746;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;79;172.2981,-733.7761;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;76;495.2981,-906.7761;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SaturateNode;81;-44.70203,-982.7764;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=7597F815073C1C271D7EC289F2EC3E92E08CF9A2