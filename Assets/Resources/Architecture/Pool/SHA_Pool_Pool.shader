...
Shader "SHA_Pool_Pool"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			half4 tex2DNode4 = tex2D( _Texture0, uv_Texture0 );
			...
			half4 color21 = IsGammaSpace() ? half4(0,0.932961,1,0) : half4(0,0.8542199,1,0);
			o.Emission = ( i.vertexColor.r * ( ( tex2D( _Texture0, ( i.uv_texcoord + ( appendResult17 * float2( 0.05,0.05 ) ) ) ).a * 0.2 ) * color21 ) ).rgb;
			o.Metallic = 0.0;
			o.Smoothness = 0.75;
			o.Alpha = 1;
		}
...
Node;AmplifyShaderEditor.ColorNode;21;-423.334,-489.8335;Inherit;False;Constant;_Color0;Color 0;3;0;Create;True;0;0;0;False;0;False;0,0.932961,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;19;-805.0005,69.16669;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0.2;False;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;2;-715.0001,-118.1667;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;22;-484.6674,71.49994;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;8;-245.0005,22.49994;Inherit;False;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;20;-198.6672,-283.8334;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=A0333CC4E116EE073F1E1CAC06F4F7E419C8FB54