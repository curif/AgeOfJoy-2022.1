...
public class ShaderProjectorLOD : ShaderScreenBase
{
    ...
    static ShaderProjectorLOD()
    {
        Low = Resources.Load<Material>("Cabinets/PreFab/CRTs/ScreenCRT_Projector_Low_LOD");
        Medium = Resources.Load<Material>("Cabinets/PreFab/CRTs/ScreenCRT_Projector_Medium_LOD");
        High = Resources.Load<Material>("Cabinets/PreFab/CRTs/ScreenCRT_Projector_High_LOD");
    }

    public ShaderProjectorLOD(Renderer display, int position, Dictionary<string, string> config) : base(display, position, config)
    {
