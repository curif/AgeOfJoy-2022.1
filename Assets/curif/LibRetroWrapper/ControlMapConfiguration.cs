...
public class DefaultControlMap : ControlMapConfiguration
{
    ...
    public DefaultControlMap() : base()
    {
        ...
        AddMap(LC.MOUSE_X, new string[] { CM.VR_CONTROLLER_RIGHT_THUMBSTICK, CM.GAMEPAD_RIGHT_THUMBSTICK, CM.MOUSE_X }, "axis");
        AddMap(LC.MOUSE_Y, new string[] { CM.VR_CONTROLLER_RIGHT_THUMBSTICK, CM.GAMEPAD_RIGHT_THUMBSTICK, CM.MOUSE_Y }, "axis");
