...
#define _ColorCore_arr AgeOfJoyNeon_Houdini
		...
		{
			float3 lerpResult14 = lerp( float3( 0,0,0 ) , float3(0.3,0.3,0.3) , i.vertexColor.b);
			o.Albedo = lerpResult14;
			...
			float4 lerpResult16 = lerp( float4( 0,0,0,0 ) , lerpResult7 , i.vertexColor.r);
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.RangedFloatNode;1;-885.9167,237.3333;Inherit;False;Property;_FresnelScale;FresnelScale;0;0;Create;True;0;0;0;False;0;False;2.32;2.67;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;2;-881.2499,14.3331;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector3Node;15;-26.33337,-117.8333;Inherit;False;Constant;_Vector0;Vector 0;3;0;Create;True;0;0;0;False;0;False;0.3,0.3,0.3;0,0,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.LerpOp;7;-244.5835,-10.66675;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;6;-577.2502,58.6666;Inherit;False;Constant;_Float1;Float 1;0;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;14;348.3334,-101.1667;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.LerpOp;13;185.0001,286.8333;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0.8;False;2;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=B9931E9E65224892832DCA20C1472000AFACC0DD